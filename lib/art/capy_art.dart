/// 카피바라 아트 — 디자인 캔버스에서 확정한 SVG를 그대로 옮겼다.
/// 캐릭터 교체는 이 파일 하나만 갈아끼우면 된다 (+ 런처 아이콘 재생성).
library;

/// 보드 토큰: 기본캐피 머리 + 흰 스티커 테두리(파스텔 타일 대비 확보).
const capyToken = '''
...
<ellipse cx="78" cy="34" rx="12" ry="10" fill="#DCAE79" stroke="#5A4531" stroke-width="6"/>
<ellipse cx="142" cy="34" rx="12" ry="10" fill="#DCAE79" stroke="#5A4531" stroke-width="6"/>
<path d="M66 44 Q110 28 154 44 Q172 54 170 88 Q170 108 184 144 Q196 184 168 204 Q140 220 110 220 Q80 220 52 204 Q24 184 36 144 Q50 108 50 88 Q48 54 66 44 Z" fill="#DCAE79" stroke="#5A4531" stroke-width="6" stroke-linejoin="round"/>
<ellipse cx="110" cy="88" rx="29" ry="42" fill="#C08A57"/>
...
<ellipse cx="86" cy="216" rx="14" ry="8" fill="#DCAE79" stroke="#5A4531" stroke-width="5"/>
<ellipse cx="134" cy="216" rx="14" ry="8" fill="#DCAE79" stroke="#5A4531" stroke-width="5"/>
<path d="M81 212 v8 M88 211 v9 M129 211 v9 M136 212 v8" stroke="#5A4531" stroke-width="3.5" stroke-linecap="round"/>
</svg>
''';

/// 완성 화면: 온천캐피 (수건 + 김 + 반신욕, 지그시 감은 눈).
const capyOnsen = '''
<svg viewBox="-10 -10 240 250" xmlns="http://www.w3.org/2000/svg">
<ellipse cx="78" cy="34" rx="12" ry="10" fill="#DCAE79" stroke="#5A4531" stroke-width="6"/>
<ellipse cx="142" cy="34" rx="12" ry="10" fill="#DCAE79" stroke="#5A4531" stroke-width="6"/>
